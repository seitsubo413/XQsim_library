...
def main():
    ...
    summary = {
        ...
        "test_type": "remaining_3",
        "total_tests": len(results),
        "passed": success_count,
        "failed": len(results) - success_count,
        "results": results
    }
    with open("test_results_complex/summary_remaining.json", "w", encoding="utf-8") as f:
        json.dump(summary, f, indent=2, ensure_ascii=False)
    print(f"\nサマリー保存: test_results_complex/summary_remaining.json")
